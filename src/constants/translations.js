export const translations = {
    en: {
        ...
        tabs: {
            ...
            historyTitle: "Historical Analytics",
            todaySub: "Live tracking of today's restaurant performance",
            historySub: "Analyze past performance and trends",
            realTime: "Real-time",
            history: "History"
        },
        kpi: {
    ...
    si: {
        ...
        tabs: {
            ...
            historyTitle: "ඓතිහාසික විශ්ලේෂණ",
            todaySub: "ආපන ශාලාවේ අද දින කාර්යසාධනය සජීවීව නිරීක්ෂණය කිරීම",
            historySub: "පසුගිය කාර්යසාධනය සහ ප්‍රවණතා විශ්ලේෂණය කරන්න",
            realTime: "සජීවී",
            history: "ඉතිහාසය"
        },
        kpi: {
            ...
            upcomingCash: "පැමිණීමට නියමිත මුදල්",
            pendingCash: "පොරොත්තු මුදල්",
            todayOnline: "අද මාර්ගගත ඇණවුම්",
            totalOnline: "මුළු මාර්ගගත ඇණවුම්",
