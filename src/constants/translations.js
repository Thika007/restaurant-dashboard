export const translations = {
    en: {
        ...
        kpi: {
            ...
            totalTax: "Total TAX",
            waste: "Wastage",
            wasteAmount: "Wastage Amount",
            wasteItems: "Wastage Items",
            refundsAmount: "Refunds Amount",
            refundsItems: "Refunded Items",
            voidAmount: "Void Amount",
            voidItems: "Void Items",
            creditAmount: "Credit Amount",
            creditPaidAmount: "Credit Paid Amount",
            creditBalance: "Credit Balance",
            txnAmount: "Transaction Amount",
            txnCount: "No of Transactions",
    ...
    si: {
        ...
        kpi: {
            ...
            waste: "අපතේ යාම් (WA)",
            wasteAmount: "අපතේ යාම් මුදල (Waste)",
            wasteItems: "අපතේ යාම් අයිතම (Items)",
            refundsAmount: "මුදල් ආපසු ගෙවීම් (Refunds)",
            refundsItems: "ආපසු ලබාගත් අයිතම (Items)",
            voidAmount: "අවලංගු කළ මුදල (Void)",
            voidItems: "අවලංගු කළ අයිතම (Items)",
            creditAmount: "ණය මුදල (Credit)",
            creditPaidAmount: "ණය ගෙවීම් මුදල (Credit paid)",
            creditBalance: "ඉතිරි ණය මුදල (Balance)",
            txnAmount: "මුළු වටිනාකම (Amount)",
            txnCount: "ගනුදෙනු සංඛ්‍යාව (Count)",
            guestTotal: "අමුත්තන් සංඛ්‍යාව (Guests)",
            app: "පුද්ගලයෙකුගේ සාමාන්‍යය (A.P.P)",
